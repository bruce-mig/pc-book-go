...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=brucemig.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x62, 0x72, 0x75, 0x63, 0x65, 0x6d, 0x69, 0x67, 0x2e, 0x70,
	...
	0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x62, 0x72, 0x75, 0x63, 0x65, 0x6d, 0x69, 0x67, 0x2e, 0x70, 0x63,
	...
	0x53, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x27, 0x0a,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: brucemig.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: brucemig.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: brucemig.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: brucemig.pcbook.Screen.resolution:type_name -> brucemig.pcbook.Screen.Resolution
	0, // 1: brucemig.pcbook.Screen.panel:type_name -> brucemig.pcbook.Screen.Panel
